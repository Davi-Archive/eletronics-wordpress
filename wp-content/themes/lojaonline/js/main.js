    ...
    responsive:{
     ...
     $(".categrie-product-activation-3").owlCarousel({
      ...
      $(".categrie-product-activation-2").owlCarousel({
        ...
        responsiveClass: true,
        navText: [
          '<button class=""slide-arrow prev-arrow slick-arrow"><i class="fas fa-long-arrow-left"></i></button>',
          '<button class="slide-arrow next-arrow"><i class="fas fa-long-arrow-right"></i></button>',
        ],
        responsive: {
          0: {
      ...
      $(".new-arrivals-product-activation-2").owlCarousel({
        infinite: true,
        slidesToShow: 4,
        slidesToScroll: 4,
        arrows: true,
      ...
      $(".recent-product-activation").owlCarousel({
        infinite: true,
        slidesToShow: 4,
        slidesToScroll: 4,
        arrows: true,
      ...
      $(".header-campaign-activation").owlCarousel({
        infinite: true,
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: true,
