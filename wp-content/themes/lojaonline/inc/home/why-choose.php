  ...
  <div class="axil-why-choose-area pb--50 pb_sm--30">
      <div class="container">
          <div class="section-title-wrapper section-title-center">
              <span class="title-highlighter highlighter-secondary"><i class="fa-solid fa-thumbs-up"></i>Porque a <?php bloginfo('title') ?></span>
              <h2 class="title">Porque as pessoas nos escolhem</h2>
          </div>
