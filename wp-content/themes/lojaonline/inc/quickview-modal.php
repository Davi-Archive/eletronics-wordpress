                                ...
                                <div class="inner">
                                    ...
                                    <div class="product-action-wrapper d-flex-center">
                                        ...
                                        <ul class="product-action d-flex-center mb--0">
                                            <li class="add-to-cart"><a href="https://new.axilthemes.com/demo/template/etrade/cart.html" class="axil-btn btn-bg-primary">Add to Cart</a></li>
                                            <li class="wishlist"><a href="https://new.axilthemes.com/demo/template/etrade/wishlist.html" class="axil-btn wishlist-btn"><i class="far fa-heart"></i></a></li>
                                        </ul>
                                        <!-- End Product Action  -->
